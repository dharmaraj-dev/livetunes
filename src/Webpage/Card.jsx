              ...
              <div className="events-box events-box-desk">
                <Row>
                  ...
                  <Col lg={2} md={3}>
                    ...
                    <div className="events-inner-box events-inner-box2 liveTunesWelcomeEasyStep1 white-color">
                      <div className="ico-sec">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="80"
            ...
            >
              <Row>
                <Col lg={8}>
                  ...
                  <p className="about-sub-heading mb-2">
                    Discover the pulse of the music scene with Trending Artists on LiveTunes—where the hottest sounds and rising stars converge. Immerse yourself in the latest musical trends and catch electrifying performances from the artists everyone is talking about. Make it special with Livetunes.
                  </p>
                </Col>
              </Row>
            ...
            >
              ...
              <Link to="/signup">
                ...
                >
                  ...
                  <div className="text-box text-box-1 l-r">
                  Join as an artist and unlock a world of opportunities to showcase your talent. Create a captivating profile, connect with music enthusiasts, and elevate your performances to new heights. Whether you're a solo artist, part of a band. <a href="https://livetunes.ai" target="_blank">LiveTunes.ai</a> is your stage to shine. Join us and let your music resonate with a global audience – it's time to amplify your artistry!"
                  </div>
                </button>
              </Link>
              </div>
