      ...
      <div className="example">
        <div onMouseEnter={disableScroll} onMouseLeave={enableScroll}>
          ...
          {items[2] && 
            <div className="home-main-sec">
                <div className="inner-home-main-sec">
                  <div className="section4 maindg postion-r" style={{background: `url(${Stepbg})`}}>
                        ...
                        <Col xl={2} lg={3} md={12}>
                          <div className="step-inner-box">
                            <div className="d-flex">
                              ...
                              <div className="st-text-sec l-r">st<br/>Step</div>
                            </div>
                            <p className="head khf l-m">Signup</p>
                            <p className="sub-head l-r">Signup to livetune with easy steps</p>
                          </div>
                        </Col>
                        <Col xl={2} lg={3} md={12}>
                          <div className="step-inner-box">
                            <div className="d-flex">
                              ...
                              <div className="st-text-sec l-r">nd<br/>Step</div>
                            </div>
                            <p className="head khf l-m">Setup your Profile</p>
                            <p className="sub-head l-r">Setup your profile to find desired artists</p>
                          </div>
                        </Col>
                        <Col xl={2} lg={3} md={12}>
                          <div className="step-inner-box">
                            <div className="d-flex">
                              ...
                              <div className="st-text-sec l-r">rd<br/>Step</div>
                            </div>
                            <p className="head khf l-m">Find Artists easily</p>
                            <p className="sub-head l-r">Find the Livetunes artists on the protal</p>
                          </div>
                        </Col>
                      </Row>
                      <Row>
                        <Col xl={2} lg={3} md={12}>
                          <div className="step-inner-box step-inner-box4">
                            <div className="d-flex">
                              ...
                              <div className="st-text-sec l-r">th<br/>Step</div>
                            </div>
                            <p className="head khf l-m">Book the artist</p>
                            <p className="sub-head l-r">Book the artists for your events</p>
                          </div>
                        </Col>
                      </Row>
                    </div>
          ...
          {items[3] && 
            <div className="home-main-sec">
                <div className="inner-home-main-sec">
                  <div className="section5 maindg postion-r" style={{background: `url(${Eventbg})`}}>
                    <Row>
                      <Col lg={8}>
                        <p className="about-heading khf red-color l-m">Event  <span className="black-color l-sb">Categories</span></p>
                      </Col>
                    </Row>
                      ...
                      <Row>
                        ...
                        <Col lg={2} md={3}>
                          ...
                          <div className="events-inner-box">
                            <div className="ico-sec">
                            <svg xmlns="http://www.w3.org/2000/svg" width="79.999" height="80" viewBox="0 0 79.999 80">
                              <g id="noun-birthday-1530773" transform="translate(-126.73 -56)">
                                <path id="Path_6103" data-name="Path 6103" d="M185.523,62.6a10.381,10.381,0,0,1-4.133-4.133l-1.054-1.928a1.043,1.043,0,0,0-1.831,0l-1.054,1.928a10.381,10.381,0,0,1-4.133,4.133l-1.928,1.054a1.043,1.043,0,0,0,0,1.83l1.928,1.054a10.381,10.381,0,0,1,4.133,4.133L178.5,72.6a1.042,1.042,0,0,0,1.83,0l1.054-1.928a10.381,10.381,0,0,1,4.133-4.133l1.928-1.054a1.043,1.043,0,0,0,0-1.83Zm-1,2.108a12.454,12.454,0,0,0-4.963,4.963l-.138.253-.139-.253a12.459,12.459,0,0,0-4.963-4.963l-.253-.139.253-.139a12.454,12.454,0,0,0,4.963-4.963l.139-.253.138.253a12.459,12.459,0,0,0,4.963,4.963l.253.139Z" transform="translate(-35.895 0)"/>
                                <path id="Path_6110" data-name="Path 6110" d="M445.592,205.1a1.044,1.044,0,0,0-.582-1.357c-15.677-6.258-27.943,3.315-28.459,3.725a1.043,1.043,0,1,0,1.3,1.63c.117-.093,11.82-9.229,26.383-3.417a1.041,1.041,0,0,0,1.357-.581Z" transform="translate(-238.968 -119.735)"/>
                                <path id="Path_6111" data-name="Path 6111" d="M290.128,92.68a1,1,0,0,0,.235.027,1.043,1.043,0,0,0,1.016-.809c.1-.432,2.362-10.666-4.628-16.857a1.044,1.044,0,0,0-1.385,1.563c6.051,5.36,4,14.731,3.977,14.825a1.045,1.045,0,0,0,.785,1.25Z" transform="translate(-130.124 -15.281)"/>
                                <path id="Path_6112" data-name="Path 6112" d="M469.518,309.35a1.044,1.044,0,1,0,.613,2c.116-.034,11.53-3.444,16.488,3.538a1.044,1.044,0,1,0,1.7-1.209c-5.82-8.2-18.276-4.484-18.8-4.324Z" transform="translate(-281.783 -207.488)"/>
                                <path id="Path_6113" data-name="Path 6113" d="M231.5,324.109a1.044,1.044,0,0,0,.15-2.076l-1.5-.22a1.044,1.044,0,0,0-.3,2.065l1.5.22a1,1,0,0,0,.153.011Z" transform="translate(-83.999 -218.396)"/>
                                <path id="Path_6114" data-name="Path 6114" d="M335.821,372.286a1.044,1.044,0,1,0-1.577,1.367l1,1.148a1.044,1.044,0,1,0,1.577-1.367Z" transform="translate(-170.303 -259.612)"/>
                                <path id="Path_6115" data-name="Path 6115" d="M323.829,342.618a1.043,1.043,0,0,0-1.348-.6l-1.418.544a1.044,1.044,0,0,0,.748,1.949l1.418-.544A1.043,1.043,0,0,0,323.829,342.618Z" transform="translate(-159.14 -234.96)"/>
                                <path id="Path_6116" data-name="Path 6116" d="M273.92,202.919a1.036,1.036,0,0,0,.373-.069l1.418-.544a1.043,1.043,0,1,0-.748-1.948l-1.418.544a1.043,1.043,0,0,0,.375,2.017Z" transform="translate(-120.093 -118.561)"/>
                                <path id="Path_6117" data-name="Path 6117" d="M248.8,290.72a1.043,1.043,0,0,0-1.348-.6l-1.418.544a1.044,1.044,0,0,0,.747,1.95l1.418-.544A1.044,1.044,0,0,0,248.8,290.72Z" transform="translate(-97.482 -192.316)"/>
                                <path id="Path_6118" data-name="Path 6118" d="M286.558,237.736a1.043,1.043,0,0,0,1.348.6l1.418-.544a1.044,1.044,0,1,0-.747-1.949l-1.419.543A1.045,1.045,0,0,0,286.558,237.736Z" transform="translate(-131.28 -147.72)"/>
                                <path id="Path_6119" data-name="Path 6119" d="M335.329,316.1l-1.5-.221a1.044,1.044,0,1,0-.3,2.065l1.5.221a.98.98,0,0,0,.154.012,1.044,1.044,0,0,0,.15-2.077Z" transform="translate(-169.199 -213.518)"/>
                                <path id="Path_6120" data-name="Path 6120" d="M388.035,329.349a1.044,1.044,0,0,0-.833,1.218l.281,1.492a1.044,1.044,0,0,0,2.052-.387l-.281-1.492A1.043,1.043,0,0,0,388.035,329.349Z" transform="translate(-213.996 -224.619)"/>
                                <path id="Path_6121" data-name="Path 6121" d="M205.579,428.207l-1.5-.221a1.044,1.044,0,1,0-.3,2.065l1.5.221a1,1,0,0,0,.154.012,1.044,1.044,0,0,0,.15-2.077Z" transform="translate(-62.577 -306.145)"/>
                                <path id="Path_6122" data-name="Path 6122" d="M267.6,266.756l1.5.221a.987.987,0,0,0,.154.012,1.043,1.043,0,0,0,.15-2.076l-1.5-.221a1.043,1.043,0,1,0-.3,2.064Z" transform="translate(-115.023 -171.463)"/>
                                <path id="Path_6123" data-name="Path 6123" d="M325.095,267.343l1.5.221a.986.986,0,0,0,.154.012,1.043,1.043,0,0,0,.15-2.076l-1.5-.221a1.043,1.043,0,1,0-.3,2.064Z" transform="translate(-162.272 -171.945)"/>
                                <path id="Path_6124" data-name="Path 6124" d="M371.879,358.819l-1.5-.221a1.044,1.044,0,0,0-.3,2.065l1.5.221a.979.979,0,0,0,.154.012,1.044,1.044,0,0,0,.15-2.077Z" transform="translate(-199.234 -248.621)"/>
                                <path id="Path_6125" data-name="Path 6125" d="M300.422,294.452a1.043,1.043,0,0,0,1.474-.078l1.016-1.128a1.043,1.043,0,1,0-1.55-1.4l-1.016,1.128a1.043,1.043,0,0,0,.077,1.474Z" transform="translate(-142.439 -193.525)"/>
                                <path id="Path_6126" data-name="Path 6126" d="M365.255,290.228a1.043,1.043,0,1,0-1.55-1.4l-1.016,1.128a1.043,1.043,0,1,0,1.55,1.4Z" transform="translate(-193.667 -191.046)"/>
                                <path id="Path_6127" data-name="Path 6127" d="M280.189,328.68l-1-1.146a1.043,1.043,0,0,0-1.575,1.369l1,1.146a1.043,1.043,0,0,0,1.575-1.369Z" transform="translate(-123.772 -222.838)"/>
                                <path id="Path_6128" data-name="Path 6128" d="M292.875,362.683a1.044,1.044,0,0,0-.585-1.356l-1.412-.561a1.044,1.044,0,0,0-.77,1.941l1.412.561a1.046,1.046,0,0,0,1.355-.585Z" transform="translate(-133.712 -250.363)"/>
                                <path id="Path_6129" data-name="Path 6129" d="M262.649,383.937a1.044,1.044,0,0,0-1.848.973l.708,1.344a1.044,1.044,0,0,0,1.848-.973Z" transform="translate(-110.063 -269.031)"/>
                                <path id="Path_6130" data-name="Path 6130" d="M238.289,416.569a1.044,1.044,0,1,0-1.848.973l.708,1.343a1.044,1.044,0,0,0,1.848-.973Z" transform="translate(-90.048 -296.413)"/>
                                <path id="Path_6131" data-name="Path 6131" d="M207.336,360.914a1.044,1.044,0,1,0,1.848-.973l-.708-1.344a1.044,1.044,0,1,0-1.848.973Z" transform="translate(-65.551 -248.207)"/>
                                <path id="Path_6132" data-name="Path 6132" d="M172.728,448.025l-1.5.2a1.044,1.044,0,0,0,.281,2.068l1.5-.2a1.044,1.044,0,0,0-.281-2.068Z" transform="translate(-35.466 -322.453)"/>
                                <path id="Path_6133" data-name="Path 6133" d="M213.658,390.052l-1.5.2a1.044,1.044,0,1,0,.281,2.068l1.5-.2a1.044,1.044,0,0,0-.281-2.068Z" transform="translate(-69.454 -274.469)"/>
                                <path id="Path_6134" data-name="Path 6134" d="M243.5,354.45l-1.5.2a1.044,1.044,0,0,0,.138,2.078,1.032,1.032,0,0,0,.141-.009l1.5-.2a1.044,1.044,0,1,0-.279-2.068Z" transform="translate(-93.975 -245.216)"/>
                                <path id="Path_6135" data-name="Path 6135" d="M304.588,389.287l-1.412-.559a1.044,1.044,0,1,0-.768,1.942l1.412.559a1.032,1.032,0,0,0,.384.073,1.044,1.044,0,0,0,.384-2.014Z" transform="translate(-143.818 -273.339)"/>
                              </g>
                            </svg>
                            </div>
                        ...
                        <Col lg={2} md={3}>
                          ...
                          <div className="events-inner-box">
                            <div className="ico-sec">
                            <svg xmlns="http://www.w3.org/2000/svg" width="76.508" height="80.507" viewBox="0 0 76.508 80.507">
                              <g id="noun-concert-3857954" transform="translate(-70.005 0.004)">
                                <path id="Path_6093" data-name="Path 6093" d="M107.535,6.336a3.8,3.8,0,1,1,7.607,0V32.329h2.536V22.82a3.8,3.8,0,1,1,7.607,0v9.509h2.536V25.356a3.8,3.8,0,1,1,7.607,0V35.5a3.782,3.782,0,0,1-.105.873,5.066,5.066,0,0,1,.105,1.028v1.268a11.4,11.4,0,0,1-.192,2.034,6.334,6.334,0,0,0,2.728-5.2V11.475a3.8,3.8,0,1,1,7.608,0V41.264l2.536-1.468V11.474a6.34,6.34,0,0,0-12.679,0v8.82a6.3,6.3,0,0,0-8.008.328,6.317,6.317,0,0,0-9.743-2.864V6.336a6.34,6.34,0,0,0-12.679,0V33.879a13.976,13.976,0,0,1,2.536-1Z" transform="translate(-29.923)"/>
                                <path id="Path_6094" data-name="Path 6094" d="M530.071,45.96a5.077,5.077,0,0,0,5.072-5.072V26.2L538.05,29.1h0a1.268,1.268,0,1,0,1.793-1.793l-5.072-5.072a1.268,1.268,0,0,0-2.165.9V36.5a5.069,5.069,0,1,0-2.536,9.457Z" transform="translate(-394.573 -18.704)"/>
                                <path id="Path_6095" data-name="Path 6095" d="M103.321,284.4c-.007-.012-.012-.025-.019-.038H80.782a1.269,1.269,0,0,1-1.268-1.268v-5.425a14.94,14.94,0,0,0,5.348.988,1.268,1.268,0,1,0,0-2.536A12.416,12.416,0,0,1,72.54,263.98V252.035a8.923,8.923,0,0,1,8.95-8.875h18.945v1.268a6.35,6.35,0,0,1-6.347,6.34H82.367a1.268,1.268,0,1,0,0,2.536,12.685,12.685,0,0,1,11.2,6.751,5.166,5.166,0,0,1,1.172-.929l.922-.533a15.336,15.336,0,0,0-4.906-5.288h3.334a8.89,8.89,0,0,0,8.883-8.875V243.16a2.539,2.539,0,0,0-2.537-2.536H81.49A11.461,11.461,0,0,0,70,252.035V263.98a14.643,14.643,0,0,0,6.974,12.435V283.1a3.807,3.807,0,0,0,3.8,3.8h23.983c-.015-.025-.032-.048-.046-.072Z" transform="translate(0 -209.563)"/>
                                <path id="Path_6096" data-name="Path 6096" d="M433.822,72.219a5.077,5.077,0,0,0,5.072-5.072V52.19l2.969,2.6a1.268,1.268,0,0,0,1.67-1.908l-5.072-4.438a1.268,1.268,0,0,0-2.1.954V62.761a5.069,5.069,0,1,0-2.536,9.457Z" transform="translate(-310.789 -41.157)"/>
                                <path id="Path_6097" data-name="Path 6097" d="M426.565,246.061l-1.4-2.425a1.29,1.29,0,0,0-1.734-.465,7.6,7.6,0,0,1-5.814.762,7.859,7.859,0,0,1-1.994-14.327,1.267,1.267,0,0,0,.464-1.73l-1.4-2.424h0a2.657,2.657,0,0,0-3.629-.985l-18.556,10.739,14.559,25.216L425.6,249.7a2.664,2.664,0,0,0,.962-3.634Z" transform="translate(-280.918 -190.931)" fill="none" stroke="#000" stroke-width="1"/>
                                <path id="Path_6098" data-name="Path 6098" d="M260.191,309.43l-18.535,10.726a2.664,2.664,0,0,0-.963,3.635l1.4,2.425a1.269,1.269,0,0,0,1.734.464,7.6,7.6,0,0,1,5.813-.761,7.858,7.858,0,0,1,1.994,14.327,1.267,1.267,0,0,0-.464,1.73l1.4,2.425a2.654,2.654,0,0,0,1.622,1.248,2.691,2.691,0,0,0,2.006-.263l18.558-10.739Zm-3.015,12.5a1.268,1.268,0,0,1-.637-2.365l2.184-1.264a1.268,1.268,0,0,1,1.27,2.2l-2.183,1.263A1.273,1.273,0,0,1,257.176,321.931Zm3.164,5.493h0a1.268,1.268,0,0,1-.636-2.365l2.184-1.264h0a1.268,1.268,0,0,1,1.27,2.194l-2.184,1.264h0a1.264,1.264,0,0,1-.634.17Zm5.981,4.058-2.183,1.263h0a1.268,1.268,0,0,1-1.27-2.2l2.183-1.263a1.268,1.268,0,0,1,1.27,2.2Z" transform="translate(-147.495 -265.739)" fill="none" stroke="#000" stroke-width="1"/>
                              </g>
                            </svg>
                            </div>
                        ...
                        <Col lg={2} md={6}>
                          <Row>
                            ...
                            <Col lg={12} md={6}>
                              <div className="events-inner-box">
                                <div className="ico-sec">
                                <svg xmlns="http://www.w3.org/2000/svg" width="79.999" height="74" viewBox="0 0 79.999 74">
                                  <g id="noun-corporate-events-2139242" transform="translate(-78.487 -30.542)">
                                    <path id="Path_6322" data-name="Path 6322" d="M251.119,176.187h26.868a1.247,1.247,0,0,0,1.244-1.244v-4.851a1.247,1.247,0,0,0-1.244-1.244H251.119a1.247,1.247,0,0,0-1.244,1.244v4.851A1.338,1.338,0,0,0,251.119,176.187Zm1.244-4.852h24.38V173.7h-24.38Z" transform="translate(-146.014 -117.727)"/>
                                    <path id="Path_6323" data-name="Path 6323" d="M251.119,258.49h26.868a1.247,1.247,0,0,0,1.244-1.244V252.4a1.247,1.247,0,0,0-1.244-1.244H251.119a1.247,1.247,0,0,0-1.244,1.244v4.851A1.338,1.338,0,0,0,251.119,258.49Zm1.244-4.851h24.38V256h-24.38Z" transform="translate(-146.014 -187.784)"/>
                                    <path id="Path_6332" data-name="Path 6332" d="M156.939,414h2.488a1.247,1.247,0,0,0,1.244-1.244,1.175,1.175,0,0,0-1.244-1.244h-2.488a1.244,1.244,0,1,0,0,2.488Z" transform="translate(-65.889 -324.342)"/>
                                    <path id="Path_6333" data-name="Path 6333" d="M156.939,473.4h2.488a1.244,1.244,0,0,0,0-2.488h-2.488a1.244,1.244,0,0,0,0,2.488Z" transform="translate(-65.889 -374.829)"/>
                                    <path id="Path_6334" data-name="Path 6334" d="M516,31.4H500.579a1.247,1.247,0,0,0-1.244,1.244v9.08a8.97,8.97,0,0,0,7.712,8.832v6.593h-4.353a1.244,1.244,0,0,0,0,2.488h11.071a1.244,1.244,0,0,0,0-2.488h-4.353V50.551a8.97,8.97,0,0,0,7.712-8.832v-9.2c.124-.622-.373-1.12-1.12-1.12Zm-1.12,2.363v4.353c-6.344-.622-9.827,1.742-13.061.622V33.758Zm-6.593,14.429a6.5,6.5,0,0,1-6.468-6.468v-.373c3.981.87,6.966-1.368,13.061-.622v1A6.612,6.612,0,0,1,508.292,48.187Z" transform="translate(-358.656 -0.728)"/>
                                    <path id="Path_6335" data-name="Path 6335" d="M92.916,58.654a1.244,1.244,0,1,0,0-2.488H88.562V49.573a8.97,8.97,0,0,0,7.712-8.832V31.786a1.247,1.247,0,0,0-1.244-1.244h-15.3a1.247,1.247,0,0,0-1.244,1.244v9.08A8.97,8.97,0,0,0,86.2,49.7V56.29H81.846a1.244,1.244,0,1,0,0,2.488H92.917Zm.995-25.625v4.353c-6.344-.622-9.826,1.742-13.061.622V33.029ZM80.85,40.866v-.373c3.981.87,6.966-1.368,13.061-.622v1a6.5,6.5,0,0,1-6.468,6.468A6.611,6.611,0,0,1,80.85,40.866Z"/>
                                  </g>
                                </svg>
                                </div>
                    ...
                    <div className="events-box events-box-mob" style={{display: `none`}}>
                      <Row className="gx-1">
                        <Col xs={3}>
                          <div className="events-inner-box">
                            <div className="ico-sec">
          ...
          <div className="home-main-sec">
              <div className="inner-home-main-sec">
                <div className="section6 maindg postion-r"  style={{background: `url(${Dreambg})`}}>
                  <div className="">
                    <div className="join-step-text-sec">
                      <p className="sub-head khf black-color l-m">Have you ever</p>
                      <p className="heading khf red-color l-m">Dreamed <span className="black-color">of a</span> Surprise GIG</p>
                      <p className="sub-bottom black-color l-sb">for your Loved ones</p>
                    </div>
                  </div>
                  <Row>
                    <Col lg={4}></Col>
                      ...
                      <Row>
                        <Col lg={4} md={4} xs={4}>
                          <div className="inner-dream-box text-center">
                            ...
                            <p className="dream-title l-sb">Valentine's day Surprise</p>
                          </div>
                        </Col>
                        <Col lg={4} md={4} xs={4}>
                          <div className="inner-dream-box inner-dream-box2 text-center">
                            ...
                            <p className="dream-title l-sb">A musical gift to say SORRY</p>
                          </div>
                        </Col>
                        <Col lg={4} md={4} xs={4}>
                          <div className="inner-dream-box text-center">
          ...
          <div className="home-main-sec">
              <div className="inner-home-main-sec">
                <div className="section7 maindg postion-r"  style={{background: `url(${Faturebg})`}}>
                    <Row>
                      <Col lg={8}>
                        <p className="about-heading khf red-color l-m">Featured <span className="black-color l-sb">artists</span></p>
                      </Col>
                    </Row>
