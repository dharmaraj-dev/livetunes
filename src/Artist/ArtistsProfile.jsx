    ...
    const nextStep = (step) => {
        ...
        if(currentStep == 1) {
            ...
            if(firstName === "" || firstName === undefined) {
                ...
                return false;
            } else if(stateId === 0 || stateId === undefined) {
                                ...
                                <div className="profile-text-sec artist-profile-text-sec">
                                    ...
                                    <Row className="align-items-center">
                                        ...
                                        <Col lg={6} md="12" className="mb-4">
                                            ...
                                            <Form.Select name="state" aria-label="Default select example" className="form-control" value={stateId} onChange={(e) => {setCityId("");selectStateAndGetItsCities(e.target.value);setStateId(e.target.value);}}
